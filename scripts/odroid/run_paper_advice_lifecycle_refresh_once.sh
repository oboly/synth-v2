...
echo "owner=public-candle-freshness-writer database_writes=0 writer_invocations=0 broker_private_calls=0 broker_writes=0 order_submission=0 live_orders=0" >&2
exit 2
