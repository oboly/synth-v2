...
echo "[MVP][OUTPUT] ${SYNTH_OPEN_ORDERS_MONITOR_HTML}"
echo "[MVP][OUTPUT] ${SYNTH_OPEN_ORDERS_MONITOR_JSON}"
echo "[MVP][OUTPUT] ${SYNTH_PROFIT_PLAN_DASHBOARD_HTML}"
echo "[MVP][OUTPUT] ${SYNTH_PROFIT_PLAN_DASHBOARD_JSON}"
