...
from src.exit_policy.automatic_exit_runtime_contract_v1 import (
    ...
    automatic_exit_idempotency_key_v1, resolve_automatic_exit_planning_enabled, resolve_automatic_exit_profile,
)
...
def test_idempotency_key_is_deterministic_and_evidence_scoped() -> None:
    ...
    assert automatic_exit_idempotency_key_v1(_evidence(market_price_snapshot_id=999)) != automatic_exit_idempotency_key_v1(_evidence())
