...
- `sector_rotation_dashboard_v1.md`
- `ui_webview.md`
- `signal_matrix_dashboard.md`
- `multi_horizon_fib_dashboard_backlog.md`
- `position_rotation_preview.md`

Files remain at their current paths until a reviewed migration batch updates all references.
