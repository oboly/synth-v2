...
| `sector_rotation_dashboard_v1.md` | **D — Phase C1 implemented / ready for review** | Read-only Sector Overview publisher over accepted Phase B snapshots; later dashboard capabilities remain open |
