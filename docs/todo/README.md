...
| `native_short_runtime_owner_and_scope_status_v1.md` | repository unit contract/preflight complete; ownership and activation UNASSIGNED | Completed Native SHORT scope/map implementation and canonical devlap unit reconciliation; installed equivalence remains a blocker |
