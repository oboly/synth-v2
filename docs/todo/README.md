...
| `profit_plan_live_ladder.md` | **A — active P1 / later** — migrated: status/priority now owned by Issues #267, #268, #269 (new), #206 and #201 (existing) | Safe prerequisites and ordered path from canonical ladder truth to authenticated preview, decision gate, execution plan, executor, and a tightly controlled live canary |
