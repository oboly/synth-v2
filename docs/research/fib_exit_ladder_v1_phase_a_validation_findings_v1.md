...
recorded there is resolved: frozen validation artifacts now exist under
`data/research/fib_exit_ladder_v1_phase_a/` and this report is computed
exclusively from them, per
...
```text
data/research/fib_exit_ladder_v1_phase_a/baseline_2020_2022.csv
data/research/fib_exit_ladder_v1_phase_a/baseline_2020_2022.json
data/research/fib_exit_ladder_v1_phase_a/validation_2022_2024.csv
data/research/fib_exit_ladder_v1_phase_a/validation_2022_2024.json
data/research/fib_exit_ladder_v1_phase_a/validation_2024_2026.csv
