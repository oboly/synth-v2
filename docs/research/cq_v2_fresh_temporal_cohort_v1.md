...
9. only then open final holdout
```
...
At the time this contract was written, only the first few September dates can exist. The full 45-as-of cohort cannot be complete before `2026-10-15T00:00:00Z`.
