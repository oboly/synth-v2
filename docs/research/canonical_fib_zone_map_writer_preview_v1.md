...
Its pivot-order leg classifier also remains research-only. Production direction
comes from the adopted `structure_state_engine` v1.2 classifier over aligned
persisted `feat_candle` inputs.
