...
ordered geometry. This upward-ladder path accepts UP maps only; DOWN maps
are not reinterpreted as profit targets. Targets above current price and retracements below it can
