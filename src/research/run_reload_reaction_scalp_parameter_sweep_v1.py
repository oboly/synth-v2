    ...
    for variant_label, variant in selected_variants:
        ...
        for row in events:
            ...
            hydrated_row = {
                ...
                "regime_source_candle_ts_utc": row.get("regime_source_candle_ts_utc"),
                "regime_asset_class": row.get("regime_asset_class"),
                "regime_global": row.get("regime_global"),
                "regime_global_version": row.get("regime_global_version"),
                "regime_asset_class_state": row.get("regime_asset_class_state"),
                "regime_asset_class_version": row.get("regime_asset_class_version"),
                "regime_bucket": row.get("regime_bucket"),
                "regime_validation_status": row.get("regime_validation_status"),
                "regime_validated_hypothesis_tags_json": row.get("regime_validated_hypothesis_tags_json"),
