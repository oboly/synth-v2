...
def _write_interrupted_state(
    *,
    ...
    # Do not hash population_path here: it may contain an uncheckpointed tail that
    # resume intentionally discards, so only FINISHED artifacts receive a population hash.
    _ = population_path
    interrupted = {
        **identity,
