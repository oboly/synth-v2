...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--max-trades-per-snapshot", nargs="+", type=int, default=[2])
    parser.add_argument("--allow-symbol-overlap", action="store_true")
    parser.add_argument("--min-test-trades-per-split", type=int, default=1)
    parser.add_argument("--min-valid-test-splits", type=int, default=6)
