...
from src.signal_engine.etl_signal_state import (
    load_assets,
    run_signal_state_for_asset_interval,
)


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run signal_state ETL"
    )
    parser.add_argument(
        "--asset",
        action="append",
    ...
    try:
        ...
        for asset in assets:
            ...
            for interval in intervals:
                ...
                rows = run_signal_state_for_asset_interval(
                    conn=conn,
                    asset_id=asset_id,
                    venue=venue,
