...
SELECT
    ...
    signal_family,
    next_return_4h
FROM v_reversion_extreme_low_participation_atr_4h
...
def main() -> None:
    ...
    if df.empty:
        print("No rows returned from v_reversion_extreme_low_participation_atr_4h.")
        return
    ...
    top = recent[
        recent["signal_family"] == "REVERSION_EXTREME_LOW_PARTICIPATION_ATR_4H_V1"
    ].sort_values(
