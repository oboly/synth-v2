...
SELECT
    ...
    signal_family,
    next_return_4h
FROM v_trend_pullback_continuation_4h
...
def main() -> None:
    ...
    if df.empty:
        print("No rows returned from v_trend_pullback_continuation_4h.")
        return
    ...
    top = recent[
        recent["signal_family"] == "TREND_PULLBACK_CONTINUATION_4H_V1"
    ].sort_values(
        ["next_return_4h", "price_vs_ema20"],
