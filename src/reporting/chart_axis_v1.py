...
def nice_domain_and_ticks(
    ...
    return NiceAxis(domain_min=domain_min, domain_max=domain_max, ticks=ticks)


def format_tick_label(value: float) -> str:
    """Deterministic, compact tick label: whole numbers with no decimal,
    otherwise trimmed to the fewest decimals needed (max 2)."""
